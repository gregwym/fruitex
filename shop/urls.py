...
urlpatterns = patterns('shop.views',
  url(r'^beta/$', 'store_spa', name='store_spa'),
  # Views
  ...
  # APIs
  url(r'^all/featured/(?P<featured_as>\w+)/items/(?P<page>\d*)', 'all_featured_items', name='all_featured_items'),
  ...
  url(r'^(?P<store_slug>\w+)/featured/(?P<featured_as>\w+)/items/(?P<page>\d*)', 'store_featured_items', name='store_featured_items'),
)
